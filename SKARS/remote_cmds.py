...
RBAN_WORK = CommandHandler("rban", rban, filters=CustomFilters.sudo_filter, run_async=True)
RUNBAN_WORK = CommandHandler("runban", runban, filters=CustomFilters.sudo_filter, run_async=True)
RKICK_WORK = CommandHandler("rpunch", rkick, filters=CustomFilters.sudo_filter, run_async=True)
RMUTE_WORK = CommandHandler("rmute", rmute, filters=CustomFilters.sudo_filter, run_async=True)
RUNMUTE_WORK = CommandHandler("runmute", runmute, filters=CustomFilters.sudo_filter, run_async=True)

dispatcher.add_handler(RBAN_WORK)
dispatcher.add_handler(RUNBAN_WORK)
dispatcher.add_handler(RKICK_WORK)
dispatcher.add_handler(RMUTE_WORK)
dispatcher.add_handler(RUNMUTE_WORK)
