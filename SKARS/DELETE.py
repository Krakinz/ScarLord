...
def purge(update: Update, context: CallbackContext):
    ...
    if msg.reply_to_message:
        ...
        if can_delete(chat, context.bot.id):
            ...
            for m_id in range(delete_to, message_id - 1, -1):
                try:
                    ...
                    if err.message == "Message can't be deleted":
                        ...
                        LOGGER.exception("Error while cleaning chat messages.")
            ...
            context.bot.send_message(chat.id, "Cleaning Done.")
        ...
        msg.reply_text("Reply to a message to select where to start cleaning from.")
