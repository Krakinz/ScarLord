...
def generate_time(to_find: str, findtype: List[str]) -> str:
    ...
    try:
        result = (
            ...
            '<b>Timezones:</b> <a href="https://en.wikipedia.org/wiki/List_of_tz_ᴋʟᴀx_ʙᴀꜱᴇ_time_zones">List here</a>'
        )
    except:
        result = None
...
def gettime(update: Update, context: CallbackContext):
    ...
    if not result:
        delmsg = send_message.edit_text(
            ...
            '<b>All Timezones:</b> <a href="https://en.wikipedia.org/wiki/List_of_tz_ᴋʟᴀx_ʙᴀꜱᴇ_time_zones">List here</a>',
