...
*Note*-\n
⚔️ •Unlocking permission *info* will allow members (non-admins) to change the group information, such as the description or the group name
⚔️ •Unlocking permission *pin* will allow members (non-admins) to pinned a message in a group
"""
