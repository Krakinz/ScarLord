...
def __stats__():
    return (
        f"{ALKL}• {sql.num_warns()} overall warns, across {sql.num_warn_chats()} chats.\n"
        f"{ALKL}• {sql.num_warn_filters()} warn filters, across {sql.num_warn_filter_chats()} chats."
    )
