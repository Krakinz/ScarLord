...
from SƈαɾLσɾԃ import (BOT_USERNAME, KLAW_LIINGS, USERBOT_ID,
                 USERBOT_NAME, USERBOT_USERNAME, aiohttpsession, app,
                 app2, arq)
from 𝚄𝚝𝚒𝚕.InlineQueryResult import *
from 𝚄𝚝𝚒𝚕.info import get_chat_info, get_user_info
